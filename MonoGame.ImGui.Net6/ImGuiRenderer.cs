...
public class ImGuiRenderer
{
    ...
    private void DrawPrimitives(int vertexOffset, int indexOffset, ImDrawListPtr commandList,
        ImDrawCmdPtr drawCommand)
    {
...
#pragma warning restore CS0618
    ...
    private unsafe void UpdateBuffers(ImDrawDataPtr drawData)
    {
        ...
        if (drawData.TotalVtxCount > _vertex.BufferSize)
        {
            ...
            _vertex.Buffer = new VertexBuffer(GraphicsDevice, DrawVertDeclaration.Declaration, _vertex.BufferSize,
                BufferUsage.None);
        ...
        if (drawData.TotalIdxCount > _index.BufferSize)
        {
            ...
            _index.Buffer = new IndexBuffer(GraphicsDevice, IndexElementSize.SixteenBits, _index.BufferSize,
                BufferUsage.None);
        ...
        for (var i = 0; i < drawData.CmdListsCount; ++i)
        {
            ...
            {
                Buffer.MemoryCopy((void*)commands.VtxBuffer.Data, vtxDstPtr, _vertex.Data.Length,
                    commands.VtxBuffer.Size * DrawVertDeclaration.Size);
                Buffer.MemoryCopy((void*)commands.IdxBuffer.Data, idxDstPtr, _index.Data.Length,
